...
# load stage2 model
cfg.model.vision_encoder.num_frames = 24
...
def load_video(video_path, timestamps, duration_annotation, num_segments=8, return_msg=False, resolution=224):
    ...
    frame_indices = get_index(num_frames, 24)
...
if __name__ == '__main__':
    ...
    for task_id, sample in tqdm(enumerate(causal_inference_list)):
        ...
        vid, msg = load_video(vid_path, times, duration, num_segments=24, return_msg=True, resolution=224)
        new_pos_emb = get_sinusoid_encoding_table(n_position=(224//16)**2*24, cur_frame=24)
    ...
    with open('./video_chat2_relation_pred_2_mistral_24frames.json', 'w') as f:
