...
results_path = 'your_path/Ask-Anything/video_chat2/results/whole_test/videochat2_llama.json'
# results_path = 'your_path/Video-LLaVA/results/whole_test/videollava_gemini.json'

anno_path = 'your_path/TimeCraft/datasets/nextgqa/sub_anno/llama/sorted_test_rewrite.csv'
