...
if __name__ == '__main__':
    ...
    for task_id, sample in tqdm(enumerate(causal_inference_list)):
        ...
        if len(description) > 3:
            ...
            vid, msg = load_video(video_path, num_segments=8, return_msg=True, resolution=224)
    ...
    with open('your_path/video_chat2/videochat2_non_causal_ep_vicuna.json', 'w') as f:
