...
config_file = "configs/config_mistral16.json"
...
if __name__ == '__main__':
    ...
    for task_id, sample in tqdm(enumerate(causal_inference_list)):
        ...
        vid, msg = load_video(vid_path, times, duration, num_segments=16, return_msg=True, resolution=224)
        new_pos_emb = get_sinusoid_encoding_table(n_position=(224//16)**2*16, cur_frame=16)
    ...
    with open('./video_chat2_relation_pred_2_mistral_16frames.json', 'w') as f:
