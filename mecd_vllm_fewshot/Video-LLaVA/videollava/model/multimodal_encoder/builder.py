...
def build_image_tower(image_tower_cfg, **kwargs):
    ...
    if image_tower.endswith('LanguageBind_Image'):
        return LanguageBindImageTower(image_tower, args=image_tower_cfg, cache_dir='your_path/Video-LLaVA/cache_dir', **kwargs)
...
def build_video_tower(video_tower_cfg, **kwargs):
    ...
    if video_tower.endswith('LanguageBind_Video_merge'):
        return LanguageBindVideoTower(video_tower, args=video_tower_cfg, cache_dir='your_path/Video-LLaVA/cache_dir', **kwargs)
