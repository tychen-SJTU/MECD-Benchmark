...
def load_and_transform_video(
    ...
    if video_decode_backend == 'pytorchvideo':
        ...
        frame_id = np.array([min(int(time * duration / duration_annotation), duration-1) for time in frame_stamps])
        frame_id_list0 = np.linspace(0, duration-1, num_frames, dtype=int)
...
class LanguageBindVideoProcessor(ProcessorMixin):
    ...
    def __call__(self, images=None, text=None, context_length=77, return_tensors=None, times=None, **kwargs):
        ...
        if images is not None:
            ...
            image_features = [self.image_processor(image, self.transform, times,
    ...
    def preprocess(self, images, times, return_tensors):
        return self.__call__(images=images, times=times, return_tensors=return_tensors)
