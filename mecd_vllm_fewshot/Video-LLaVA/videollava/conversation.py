...
conv_llava_v1_multi_videos = Conversation(
    system="A chat between a curious user and an artificial intelligence assistant."
           "In addition to the main video, the user will offer some related videos to assist answering."
           "The assistant gives helpful, detailed, and polite answers to the user's questions.",
    roles=("USER", "ASSISTANT"),
    version="v1",
    messages=(),
...
conv_llava_sg_video = Conversation(
    system="A chat between a curious user and an artificial intelligence assistant."
           "In addition to the video, the user will offer its corresponding relation graph to assist answering."
           "The assistant gives helpful, detailed, and polite answers to the user's questions.",
    roles=("USER", "ASSISTANT"),
    version="sg_video",
    messages=(),
...
conv_llava_causal_qa = Conversation(
    system="A chat between a curious user and an artificial intelligence assistant. "
           "The assistant is able to understand the visual content that the user provides, "
           "and assist the user with a variety of tasks using natural language. "
           "You can give an answer by carefully thinking step by step by analyzing the visual contents "
           "(and causal relations if necessary (when facing complex question)). ",
    roles=("USER", "ASSISTANT"),
    messages=(),
    offset=0,
    sep_style=SeparatorStyle.TWO,
