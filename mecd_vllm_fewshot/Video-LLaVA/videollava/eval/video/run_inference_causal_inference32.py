...
def get_model_output(model, video_processor, tokenizer, video, qs, task_id, times, args):
    ...
    video_tensor = video_processor.preprocess(video, times=times, num_frames=32, return_tensors='pt')['pixel_values'].bfloat16().to(args.device)
...
def run_inference(args):
    ...
    with open('your_path/Video-LLaVA/videollava_relation_pred32.json', 'w') as f:
