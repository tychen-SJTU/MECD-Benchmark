...
def parse_args():
    ...
    return parser.parse_args([  '--model_path', '/home/tychen/Video-LLaVA/checkpoints/videollava-7b',
                                ...
                                '--gt_file_qa', '/home/tychen/Video-LLaVA/eval/GPT_Multi_Videos_QA/Activitynet_Multi_Videos_QA/QA_val_reason_fewshot.json',
...
def run_inference(args):
    ...
    causal_inference_file = '/home/hbliu/Ask-Anything/video_miniGPT4/val_caption_small3_updated_large.json'
    ...
    for task_id, sample in tqdm(enumerate(causal_inference_list)):
        ...
        main_video_path = '/home/tychen/Video-LLaVA/eval/GPT_Multi_Videos_QA/Activitynet_Multi_Videos_QA/val/v__1vYKA7mNLI.mp4'
    ...
    with open('/home/tychen/Video-LLaVA/videollava_relation_pred.json', 'w') as f:
