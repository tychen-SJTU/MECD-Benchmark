...
if __name__ == '__main__':
    results = {}
    test_csv_file = '/home/hbliu/TimeCraft/datasets/nextgqa/sub_anno/puyu/sorted_test_rewrite.csv'
    ...
    for index, row in df.iterrows():
        ...
        if index % 100 == 0:
            with open('/home/hbliu/Ask-Anything/video_chat2/results/whole_test/videochat2_puyu.json', 'w') as f:
                json.dump(results, f)
